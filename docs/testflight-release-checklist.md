...
The evidence report should show the intended release commit and version. The audit should finish with zero failures. The Xcode warning should disappear after full Xcode is active.
